...
Public Class SpotnetProgressChangedEventArgs
    ...
    Public Sub New( _
        ...
        ByVal progressMessage As String, _
...
Public Class SpotsCompletedEventArgs
    ...
    Public Sub New( _
    ByRef tSpots As List(Of Spot), _
    ByRef tDeletes As HashSet(Of String), _
...
Public Class CommentsCompletedEventArgs
    ...
    Public Sub New( _
    ByRef tComments As List(Of Comment), _
    ByVal e As Exception, _
    ByVal Cancelled As Boolean, _
    ByVal State As Object)
